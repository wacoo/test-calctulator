...
<div align="center">
  ...
  <h3><b> Math Magician-project README Template</b></h3>
...
**[ Math Magician ]**  Math Magician. It's an interactive website for honing math skills. Practice addition, subtraction, multiplication, and division through engaging quizzes and games.
...
```sh
  cd [my-folder]
  git clone https://github.com/mumbereh/app.git
```
